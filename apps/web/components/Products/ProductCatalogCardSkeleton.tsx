...
const ProductCatalogCardSkeleton = () => {
    return (
        <div className='h-110 flex flex-col justify-between items-center relative bg-white p-4 rounded-lg border border-gray-100 animate-pulse'>
            <div className='self-end h-8 w-8 bg-gray-200/75 rounded-full'></div>
            <div className='h-45 w-45 bg-gray-200/75 rounded-lg flex items-center justify-center'>
